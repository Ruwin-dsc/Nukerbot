...
WHITEHALL NUKER     
                    ...
                    Prefix: ${prefix}
    `))
    nuker.user.setActivity({ name: ".gg/whitehall", type: "PLAYING" });
});
...
nuker.on("messageCreate", (message) => {
    ...
    const help = new MessageEmbed()
        .setDescription(`__**Raid Bot Made By WhiteHall**__
    \n**mass channels ;**
...
//bot made by Prada (.gg/whitehall)